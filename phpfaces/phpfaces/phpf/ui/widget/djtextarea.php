...
class DjTextArea extends  Component {

    function load($args) {
        //parent::load ( $args );
$this->attributes= $args;
    }
    function DjTextArea (FacesController &$controller,$args=null) {
  ...
  function setText($val) {
    ...
    function startTag() {
        $html= '<textarea  dojoType="dijit.form.Textarea" ';
     ...
     public static function addDojo() {
        return 'dojo.require("dijit.form.Textarea");';
    }
}
?>